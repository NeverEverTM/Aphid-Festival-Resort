...
public partial class LoadScreen : CanvasLayer
{
	...
	[Export] private AudioStream leaves_sound;
	...
	public async Task CreateLeaves()
	{
		...
		for (int i = 0; i < virtualNodes.Count; i++)
		{
            ...
            _leaf.GlobalPosition = GlobalManager.Utils.GetRandomVector_X(0, (int)windowSize.X, -600);
	...
	public async Task SweepLeaves()
	{
		...
		for (int i = 0; i < leafNodes.Count; i++)
		{
			...
			_leaf.position_final = GlobalManager.Utils.GetRandomVector_Y(0, windowSize.Y, -600);
