...
public partial class FoodData : Resource
{
    ...
    [Export] public AphidData.FoodType Type { get; set; } = AphidData.FoodType.Neutral;
...
#pragma warning disable IDE0290 // Use primary constructor
    public FoodData(AphidData.FoodType Type, int FoodValue, int DrinkValue, Dictionary<AphidData.SkillEnum, int> Skills)
    {
        this.Type = Type;
