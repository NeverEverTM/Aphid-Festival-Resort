...
public partial class TVScreenStructure : Sprite2D, SaveSystem.IGenericDataModule
{
	...
	public readonly static List<ITVChannel> catalog = [
	...
	public class VideoPlayerChannel : ITVChannel
	{
		...
		private readonly int maxDistanceSquared = 400 * 400;
